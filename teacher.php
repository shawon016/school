    ...
    <div class="row">
        ...
        <div class="col-9 mt-5 ms-4 shadow-lg bg-body-tertiary rounded">
            <div class="d-flex justify-content-between m-3">
                <h3 class="fw-bold">All Teachers</h3>
                <button type="button" class="btn btn-primary fw-bold" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Teacher</button>
            </div>
                    ...
                    if(!$result){
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['teachers_department']; ?></td>
                                <td><?php echo $row['teachers_mobile']; ?></td>
                                <td><?php echo $row['teachers_email']; ?></td>
                                <td>
                                    <a href="update_teacher.php?teachers_id=<?php echo $row['teachers_id'];?>" class="btn btn-success fw-bold">Edit</a>
                                    <a href="delete_teacher.php?teachers_id=<?php echo $row['teachers_id'];?>" class="btn btn-danger fw-bold">Delete</a>
                                </td>
                            </tr>
                            <?php
                        }
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-4 fw-bold" id="exampleModalLabel">Teacher Information</h1>
      ...
      <div class="modal-body">
        <form action="add_teacher.php" method="POST">
            ...
            <div class="form-group mb-2">
                <label for="" class="pb-2 fw-bold">Teachers's Department</label>
                <input type="text" name="teachers_department" class="form-control">
            </div>
            <div class="form-group mb-2">
                <label for="" class="pb-2 fw-bold">Teacher's Mobile</label>
                <input type="text" name="teachers_mobile" class="form-control">
            </div>
            <div class="form-group mb-2">
                <label for="" class="pb-2 fw-bold">Teacher's Email</label>
                <input type="text" name="teachers_email" class="form-control">
            </div>
                <button type="submit" name="add_teacher" class="btn btn-primary fw-bold">Save</button>
        </form>
      </div>
    </div>
  </div>
